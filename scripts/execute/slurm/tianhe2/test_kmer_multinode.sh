...
statout=$scratchdir/mimir_lb_results/kmer/tianhe2-kmer-multinode/
...
params="mcount -t 1 -o $output.24G -s 256M -m 22 --text $filelist"
...
params="mcount -t 1 -o $output.48G -s 256M -m 22 --text $filelist"
...
params="mcount -t 1 -o $output.96G -s 256M -m 22 --text $filelist"
...
params="mcount -t 1 -o $output.192G -s 256M -m 22 --text $filelist"
