...
python draw_mimir_mrmpi_memory_and_time.py wordcount wikipedia \
    ...
    --indir2  ../../data/mrmpi/comet/ \
    --outfile comet-singlenode-wc-wikipedia-baseline-memory-time.pdf \
    --settings1 "basic" \
    --settings2 "p64,p512" \
    --labellist1 "Mimir (basic)" \
    --labellist2 "MR-MPI (64M),MR-MPI (512M)" \
...
python draw_mimir_mrmpi_memory_and_time.py bfs graph500 \
    singlenode s19,s20,s21,s22,s23,s24,s25,s26  s27,s21,s24\
    "2^19,2^20,2^21,2^22,2^23,2^24,2^25,2^26" \
    --indir1 ../../data/comet/bfs_graph500_singlenode_c64M-p64M-i512M-h20/ \
    --indir2  ../../data/mrmpi/comet/ \
    --outfile comet-singlenode-bfs-graph500-baseline-memory-time.pdf \
    --settings1  "basic" \
    --settings2  "p64,p512" \
    --labellist1  "Mimir (basic)" \
    --labellist2  "MR-MPI (64M),MR-MPI (512M)" \
