...
#label=$benchmark-$datatype-$dataset
#input=$scratchdir/words/$dataset
#filelist=$(../get_file_list.sh $input 25769803776 "")
#filelist=$input
#params="$output.6 $filelist"
#prejob=$($scriptdir/run.job.sh config.bigdata.h $jobname $label 1 24 $exe "$params" $statout $prejob)
#echo $prejob
...
#filelist=$(../get_file_list.sh $input 25769803776 "")
#filelist=$input
#params="$output.9 $filelist"
#prejob=$($scriptdir/run.job.sh config.bigdata.h $jobname $label 1 24 $exe "$params" $statout $prejob)
#echo $prejob

jobname=$jobstr
dataset=16G-100m-1.0
label=$benchmark-$datatype-$dataset
input=$scratchdir/words/$dataset
#filelist=$(../get_file_list.sh $input 25769803776 "")
filelist=$input
params="$output.10 $filelist"
prejob=$($scriptdir/run.job.sh config.bigdata.h $jobname $label 1 24 $exe "$params" $statout $prejob)
echo $prejob
