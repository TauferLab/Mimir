...
make clean
make wordcount CC=$FLAGS CFLAGS="-DKV_HINT"
make octree CC=$FLAGS CFLAGS="-DKV_HINT"
make bfs CC=$FLAGS CFLAGS="-DKV_HINT -DOUTPUT_RESULT"
...
make bfs CC=$FLAGS CFLAGS="-DPART_REDUCE -DCOMPRESS -DKV_HINT -DOUTPUT_RESULT"
