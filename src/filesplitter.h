...
class FileSplitter
{
  ...
  public:
    ...
    void split(InputSplit* input, std::vector<InputSplit>& files,
    ...
    void split(const char* indir, std::vector<InputSplit>& files,
               SplitPolicy policy = BYNAME)
    {
  ...
  private:
    ...
    void split_files(InputSplit* input, std::vector<InputSplit>& files,
                     SplitPolicy policy);
